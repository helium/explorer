  ...
  render() {
    ...
    return (
      <AppLayout>
              ...
              <Title style={{color: 'white', fontSize: 52, marginTop: 0, lineHeight: 0.7, letterSpacing: '-2px', marginBottom: 17}}>
                  {hotspot.name}
                </Title>
              <Tooltip placement="bottom" title="Hotspot Network Address">
                <Text copyable style={{fontFamily: 'monospace', color: '#8283B2'}}>
                      <img src={HotspotImg} style={{height: 15, marginRight: 5, position: 'relative', top: '-2px'}} />{hotspot.address}
                    </Text>
                    </Tooltip>
              ...
              <div className="bottombar">
                        ...
                        <p style={{color: 'white', margin: 0}}>Owned by: <a href={'/accounts/' + hotspot.owner}>{hotspot.owner}</a></p>
                        </Content>
              </div>

</Content>

        <Content style={{ marginTop: '20px', margin: '0 auto', maxWidth: 850, paddingBottom: 100, }}>
