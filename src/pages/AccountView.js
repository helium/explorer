...
class AccountView extends Component {
  ...
  render() {
      ...
      <AppLayout>
       <Content style={{ marginTop: 0, background: '#27284B', padding: '80px 0 50px', overflowX: 'scroll' }}>
         ...
         <Title code level={4} copyable style={{color: 'white', marginBottom: 0, fontWeight: 300}}>
                  ...
                  <Fade bottom>
                  <Title style={{color: '#38A2FF', fontWeight: 400, marginTop: 20, height: 60}}>
                  {!loading && (
    ...
    <Tooltip placement="bottom" title="The amount of Security Tokens this account owns.">
              <h3 style={{margin:'0 20px'}}><CheckCircleOutlined style={{color: '#29D391', marginRight: 5}} /> 
              {!loading && (
