  ...
  return (
    <div className="fixed top-0 mx-auto w-full z-50">
      <div className="relative w-full">
        ...
        >
          <span className="m-0 mr-1 inline-flex w-full items-center justify-center">
            <span>
              Check out the new Earnings Map layer.{' '}
              <span className="hidden md:inline-flex">Click</span>
              <span className="inline-flex md:hidden">Tap</span> the
              <svg
                width="20"
                height="18"
              ...
              <span className="inline-flex">
                icon in the bottom right corner and select Earnings.
              </span>
            </span>
          </span>
        </a>
